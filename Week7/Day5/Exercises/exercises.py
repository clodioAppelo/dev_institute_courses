...
my_kwargs = check_keywordedarguments(
    name="Sarah", age=24, profession='coder', favortie_food='burgers')
...
check_arguments_keywordedarguments(
    "hello world", 1, 2, 'hey', name="Sarah", age=24)
...
filtered_object = filter(lambda s: "A" in s.upper()
                         and 'e' in s.lower(), fruit)
